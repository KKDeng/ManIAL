    ...
    for id_r = 1 :size(r_set,1) % r  number of column
        for id_mu = 1:length(mu_set)  %mu  sparsity parameter
            ...
            for test_random =1:test_num  %times average.
                ...
                [phi_init1]= Re_sub_grad_spca(H,option_Rsub);
                ...
                options_mialm.max_iter = 100;     options_mialm.maxitersub = 10;
                ...
                option_manpg.L = L; option_manpg.F_mialm = out_mialm.obj + 3e-4;
                ...
                [X_Rsub, F_Rsub,sparsity_Rsub,time_Rsub,...
                    maxit_att_Rsub,succ_flag_sub,obj_arr_Rsub,time_arr_Rsub]= Re_sub_grad_spca(H,option_Rsub);
                ...
                if is_plot
                 hold on
                plot(out_mialm.time_arr(1:out_mialm.iter),out_mialm.obj_arr(1:out_mialm.iter))
                plot(out_madmm.time_arr(1:out_madmm.iter),out_madmm.obj_arr(1:out_madmm.iter))
                plot(time_arr_manpg(1:maxit_att_manpg-1),obj_arr_manpg(1:maxit_att_manpg-1))
                plot(time_arr_manpg_BB(1:maxit_att_manpg_BB-1),obj_arr_manpg_BB(1:maxit_att_manpg_BB-1))
