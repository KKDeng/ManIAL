...
for cross_b = 1:5
    ...
    option_amanpg.maxiter = 1e3;    option_amanpg.tol =1e-8;   option_amanpg.inner_tol = 1e-10;
    ...
    [result_manpg_alt] = scca_amanpg(Xtrain,Ytrain,option_amanpg,'l21');
    ...
    if r == 1
        result_manpg_alt.lossu = 2*(1-abs(uhat'*option_amanpg.u_n));
        result_manpg_alt.lossv = 2*(1-abs(vhat'*option_amanpg.v_n));
    end
    [~,~,result_manpg_alt.rho]  = canoncorr(option_amanpg.Xtest * uhat, option_amanpg.Ytest * vhat);
