 # Code of augmented Lagrangian method for nonsmooth problem on Riemannian manifold
...
If you use these codes in an academic paper, please cite the following papers.
 ...
 Kangkang, Deng, and Peng Zheng, [*An inexact augmented Lagrangian method for nonsmooth optimization on Riemannian manifold,IMA Journal of Numerical Analysis*](https://doi.org/10.1093/imanum/drac018)).
  ...
  Kangkang, Deng, and Jiang Hu, and Jiayuan Wu, and Zaiwen Wen, [*Oracle Complexities of Augmented Lagrangian Methods for Nonsmooth Composite Optimization on a Compact Submanifold,Mathematics of Operations Research*](https://pubsonline.informs.org/doi/10.1287/moor.2024.0498)).

1. https://github.com/chenshixiang/ManPG
2. https://github.com/chenshixiang/AManPG
3. https://github.com/xiao-li-hub/Riemannian-subgradient-methods
4. https://github.com/NicolasBoumal/manopt
5. http://cvxr.com/tfocs/
6. Sparse CCA: Adaptive estimation and computational barriers.




## To Contact Us
If you have any questions or find any bugs, please feel free to contact us by email (freedeng1208@gmail.com).
